...
export default function Hero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // If the intro finished before the listener mounted (e.g. fast refresh).
  ...
  return (
    ...
    >
      {/* Background Image - Full coverage on all devices with mobile optimization */}
      <div 
        ref={backgroundRef}
      ...
      {/* Title & Subtitle - Perfectly Centered */}
      <div 
        ref={titleRef}
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex justify-center">
            <button className="px-12 sm:px-16 md:px-20 py-2.5 sm:py-3 bg-white/10 backdrop-blur-sm text-white text-xs sm:text-sm font-semibold border border-white/30 rounded hover:bg-white/20 transition-all uppercase tracking-wider">
              Build Your Vision
            </button>
          </div>
        </div>
